...
describe("Entities reducer tests", () => {
  ...
  describe("Actions", () => {
    ...
    it("dispatches FETCH_PROVEEDOR_LIST actions", async () => {
    ...
    it("dispatches FETCH_PROVEEDOR actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches CREATE_PROVEEDOR actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches UPDATE_PROVEEDOR actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches PARTIAL_UPDATE_PROVEEDOR actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches DELETE_PROVEEDOR actions", async () => {
      const expectedActions = [
        {
