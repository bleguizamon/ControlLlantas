...
describe("Entities reducer tests", () => {
  ...
  describe("Requests", () => {
    it("should set state to loading", () => {
      testMultipleTypes(
        [getEntities.pending.type, getEntity.pending.type],
        {},
        (state) => {
          expect(state).toMatchObject({
            errorMessage: null,
  ...
  describe("Actions", () => {
    ...
    it("dispatches FETCH_RUTAVEHICULO_LIST actions", async () => {
    ...
    it("dispatches FETCH_RUTAVEHICULO actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches CREATE_RUTAVEHICULO actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches UPDATE_RUTAVEHICULO actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches PARTIAL_UPDATE_RUTAVEHICULO actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches DELETE_RUTAVEHICULO actions", async () => {
      const expectedActions = [
        {
