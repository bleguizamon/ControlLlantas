...
describe("Entities reducer tests", () => {
  ...
  describe("Actions", () => {
    ...
    it("dispatches FETCH_RUTA_LIST actions", async () => {
    ...
    it("dispatches FETCH_RUTA actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches CREATE_RUTA actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches UPDATE_RUTA actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches PARTIAL_UPDATE_RUTA actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches DELETE_RUTA actions", async () => {
      const expectedActions = [
        {
