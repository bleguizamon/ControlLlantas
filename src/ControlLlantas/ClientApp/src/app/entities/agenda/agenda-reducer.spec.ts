...
describe("Entities reducer tests", () => {
  ...
  describe("Actions", () => {
    ...
    it("dispatches FETCH_AGENDA_LIST actions", async () => {
    ...
    it("dispatches FETCH_AGENDA actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches CREATE_AGENDA actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches UPDATE_AGENDA actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches PARTIAL_UPDATE_AGENDA actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches DELETE_AGENDA actions", async () => {
      const expectedActions = [
        {
