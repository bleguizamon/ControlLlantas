...
describe("Entities reducer tests", () => {
  ...
  describe("Actions", () => {
    ...
    it("dispatches FETCH_CONDUCTOR_LIST actions", async () => {
    ...
    it("dispatches FETCH_CONDUCTOR actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches CREATE_CONDUCTOR actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches UPDATE_CONDUCTOR actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches PARTIAL_UPDATE_CONDUCTOR actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches DELETE_CONDUCTOR actions", async () => {
      const expectedActions = [
        {
