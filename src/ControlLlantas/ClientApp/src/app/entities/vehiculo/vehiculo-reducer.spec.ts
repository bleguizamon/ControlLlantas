...
describe("Entities reducer tests", () => {
  ...
  describe("Actions", () => {
    ...
    it("dispatches FETCH_VEHICULO_LIST actions", async () => {
    ...
    it("dispatches FETCH_VEHICULO actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches CREATE_VEHICULO actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches UPDATE_VEHICULO actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches PARTIAL_UPDATE_VEHICULO actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches DELETE_VEHICULO actions", async () => {
      const expectedActions = [
        {
