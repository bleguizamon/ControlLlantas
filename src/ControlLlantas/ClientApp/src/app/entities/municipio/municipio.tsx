...
export const Municipio = (props: RouteComponentProps<{ url: string }>) => {
    ...
    <div>
      ...
      <div className="table-responsive">
        {municipioList && municipioList.length > 0 ? (
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {municipio.departamento ? (
                      <Link to={`/departamento/${municipio.departamento.id}`}>
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/municipio/${municipio.id}/delete`}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">No Municipios found</div>
          )
        )}
      </div>
    </div>
