...
describe("Entities reducer tests", () => {
  ...
  describe("Actions", () => {
    ...
    it("dispatches FETCH_MUNICIPIO_LIST actions", async () => {
    ...
    it("dispatches FETCH_MUNICIPIO actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches CREATE_MUNICIPIO actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches UPDATE_MUNICIPIO actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches PARTIAL_UPDATE_MUNICIPIO actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches DELETE_MUNICIPIO actions", async () => {
      const expectedActions = [
        {
