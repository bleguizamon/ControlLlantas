...
describe("Entities reducer tests", () => {
  ...
  describe("Actions", () => {
    ...
    it("dispatches FETCH_DEPARTAMENTO_LIST actions", async () => {
    ...
    it("dispatches FETCH_DEPARTAMENTO actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches CREATE_DEPARTAMENTO actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches UPDATE_DEPARTAMENTO actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches PARTIAL_UPDATE_DEPARTAMENTO actions", async () => {
      const expectedActions = [
        {
    ...
    it("dispatches DELETE_DEPARTAMENTO actions", async () => {
      const expectedActions = [
        {
