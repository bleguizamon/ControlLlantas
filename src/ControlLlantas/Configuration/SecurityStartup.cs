using System;
using And.ControlLlantas.Infrastructure.Configuration;
using System.IdentityModel.Tokens.Jwt;
using System.Text;
using And.ControlLlantas.Infrastructure.Data;
using And.ControlLlantas.Domain;
using And.ControlLlantas.Security;
using And.ControlLlantas.Security.Jwt;
using And.ControlLlantas.Domain.Services;
...
using AuthenticationService = And.ControlLlantas.Domain.Services.AuthenticationService;
using IAuthenticationService = And.ControlLlantas.Domain.Services.Interfaces.IAuthenticationService;
