...
{
    public class ReadOnlyRutaRepository : ReadOnlyGenericRepository<Ruta, long>, IReadOnlyRutaRepository
    {
        public ReadOnlyRutaRepository(IUnitOfWork context) : base(context)
        {
        }
    }
}
