...
{
    public class ReadOnlyAgendaRepository : ReadOnlyGenericRepository<Agenda, long>, IReadOnlyAgendaRepository
    {
        public ReadOnlyAgendaRepository(IUnitOfWork context) : base(context)
        {
        }
    }
}
