...
{
    public class ReadOnlyProveedorRepository : ReadOnlyGenericRepository<Proveedor, long>, IReadOnlyProveedorRepository
    {
        public ReadOnlyProveedorRepository(IUnitOfWork context) : base(context)
        {
        }
    }
}
