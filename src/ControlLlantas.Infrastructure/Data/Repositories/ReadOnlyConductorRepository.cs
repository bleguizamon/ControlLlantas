...
{
    public class ReadOnlyConductorRepository : ReadOnlyGenericRepository<Conductor, long>, IReadOnlyConductorRepository
    {
        public ReadOnlyConductorRepository(IUnitOfWork context) : base(context)
        {
        }
    }
}
